...
//Question : 06 Practice placement of <script></script> element in following sections of your project in exercise 6:
// a. Head
...
var name = "Muhammad Mughees";
var age = 22;
var course = "Certified Mobile and Application Hybrid Development";
alert(name);
alert(age + " years old");
alert(course);
...
//Question : 06. Declare a variable called email and assign to it a string that represents your Email Address(e.g. example@example.com).
// Show the blow mentioned message in an alert box.(Hint: use string concatenation)
var email = "muhammadmughees125@gmail.com";
...
//Question : 07. Declare a variable called book & give it the value “A smarter way to learn JavaScript”.
...
document.write("Yaah! I can write HTML content through JavaScript");





//Question : 09. Store following string in a variable and show in alert and browser through JS “▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬”
var symbol = "“▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬”";
alert(symbol);
...
//Question : 02. Declare & initialize a variable to keep track of how many times a visitor has visited a web page. Show his/her
...
var visitorName = "Muhammad Mughees";
var productTitle = "Shirts";
var quantity = 9;
document.write(visitorName + " ordered " + quantity + " " + productTitle + " on Denim Clothing store");
...
// ----------- ChapterL: 04 VARIABLE NAMES: LEGAL & ILLEGAL ----------
...
//Question : 02. Repeat task1 for subtraction, multiplication, division & modulus.
// Subtraction
...
//Question : 04. Cost of one movie ticket is 600 PKR. Write a script to store ticket price in a variable &
...
//Question : 05. Write a script to display multiplication table of any number in your browser. E.g
var tableNumber = 4;
var i = 0;
...
//Question : 06. The Temperature Converter: It’s hot out! Let’s make a converter based on the steps here.
...
//Question : 07. Write a program to implement checkout process of a shopping cart system for an e-commerce website. Store
...
//Question : 08. Store total marks & marks obtained by a student in 2 variables. Compute the percentage & show the result in your browser
var totalMarks = 1100;
var marksObtained = 990;
...
//Question : 09. Assume we have 10 US dollars & 25 Saudi Riyals. Write a script to convert the total currency to Pakistani Rupees.
...
//Question : 03. Write a program that takes input a name from user & greet the user.
...
//Question : 05. Write a program to take input a number from user & display it’s multiplication table on your browser. If user
...
//Question : 01. Write a program to take “city” name as input from user. If user enters “Karachi”,
...
//Question : 02. Write a program to take “gender” as input from user. If the user is male, give the message:
...
//Question : 06. Write a program to take input the marks obtained in three subjects & total marks. Compute & show the resulting
...
//Question : 08. Write a program to check whether the given number is divisible by 3. Show the message to the
...
//Question : 01. Write a program that takes a character (number or string) in a variable & checks whether the given input is a
...
//Question : 07. Write a program that takes time as input from user in 24 hours clock format like: 1900 = 7pm.
...
//Question : 01. Declare an empty array using JS literal notation to store student names in future. 
var students = [];




//Question : 02. Declare an empty array using JS object notation to store student names in future. 
...
//Question : 07. Declare and Initialize an array and store available education qualifications in Pakistan (e.g. SSC, HSC, BCS, BS, BCOM, MS, M. Phil., PhD).
...
//Question : 08. Write a program to store 3 student names in an array.Take another array to store score of these three students.
...
var cities = ["Karachi", "Lahore", "Islamabad", "Quetta", "Naran", "Multan"];
...
//Question : 01. Declare and initialize an empty multidimensional array.(Array of arrays)
var arr = [];
...
//Question : 04. Write a program to print multiplication table of any number using for loop.
